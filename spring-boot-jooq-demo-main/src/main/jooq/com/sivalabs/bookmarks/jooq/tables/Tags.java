...
public class Tags extends TableImpl<TagsRecord> {
    ...
    /**
     * The reference instance of <code>jooq_db.tags</code>
     */
    ...
    /**
     * The column <code>jooq_db.tags.id</code>.
     */
    public final TableField<TagsRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "");

    /**
     * The column <code>jooq_db.tags.name</code>.
     */
    public final TableField<TagsRecord, String> NAME = createField(DSL.name("name"), SQLDataType.VARCHAR(100).nullable(false), this, "");

    /**
     * The column <code>jooq_db.tags.created_at</code>.
     */
    public final TableField<TagsRecord, LocalDateTime> CREATED_AT = createField(DSL.name("created_at"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");

    /**
     * The column <code>jooq_db.tags.updated_at</code>.
     */
    public final TableField<TagsRecord, LocalDateTime> UPDATED_AT = createField(DSL.name("updated_at"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>jooq_db.tags</code> table reference
     */
    ...
    /**
     * Create a <code>jooq_db.tags</code> table reference
     */
    public Tags() {
    ...
    public List<UniqueKey<TagsRecord>> getUniqueKeys() {
        return Arrays.asList(Keys.KEY_TAGS_TAG_NAME_UNIQUE);
    }
