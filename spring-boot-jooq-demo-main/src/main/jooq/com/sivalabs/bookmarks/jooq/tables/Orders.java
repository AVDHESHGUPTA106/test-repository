...
import com.sivalabs.bookmarks.jooq.tables.Customers.CustomersPath;
...
public class Orders extends TableImpl<OrdersRecord> {
    ...
    /**
     * The reference instance of <code>jooq_db.orders</code>
     */
    ...
    /**
     * The column <code>jooq_db.orders.order_id</code>.
     */
    ...
    /**
     * The column <code>jooq_db.orders.customer_id</code>.
     */
    ...
    /**
     * The column <code>jooq_db.orders.order_date</code>.
     */
    public final TableField<OrdersRecord, LocalDateTime> ORDER_DATE = createField(DSL.name("order_date"), SQLDataType.LOCALDATETIME(0).defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP"), SQLDataType.LOCALDATETIME)), this, "");
    ...
    /**
     * Create an aliased <code>jooq_db.orders</code> table reference
     */
    ...
    /**
     * Create a <code>jooq_db.orders</code> table reference
     */
    public Orders() {
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.ORDERS_CUSTOMER_ID);
    }
    ...
    /**
     * Get the implicit join path to the <code>jooq_db.customers</code> table.
     */
    public CustomersPath customers() {
        if (_customers == null)
            _customers = new CustomersPath(this, Keys.ORDERS_IBFK_1, null);
    ...
    public OrderItemsPath orderItems() {
        if (_orderItems == null)
            _orderItems = new OrderItemsPath(this, null, Keys.ORDER_ITEMS_IBFK_1.getInverseKey());
